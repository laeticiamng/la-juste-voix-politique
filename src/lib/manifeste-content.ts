...
export const manifesteContent = {
  title: "La Juste Voix",
  content: `MANIFESTE DE JUSTICE CONTRIBUTIVE
...
Des moments où les faits deviennent trop lourds pour qu'on les nie encore.

Aujourd'hui, des milliards dorment dans des comptes qui ne servent à rien.
Pendant ce temps :
	• Des soignants pleurent de fatigue dans des couloirs bondés.
	• Des enseignants tiennent debout à bout de nerfs.
...
Mais nous ?
Nous avons besoin de transports qui fonctionnent.
De logements accessibles.
D'écoles qui ne s'effondrent pas.
De médecins qui ne fuient plus l'hôpital.
...
Je veux qu'en France,
	...
	• un médecin ne soit pas un survivant,
