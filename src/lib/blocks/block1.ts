  ...
  detailedMeasures: [
    ...
    },
    {
      ...
      details: [
        ...
        "---",
        "",
        "**🔁 TRANSFORMATION DES AIDES – Détail aide par aide**",
        "",
        "**1️⃣ RSA (Revenu de Solidarité Active)**",
        "",
        "Avant : Une somme d'argent versée chaque mois, sans activité réaliste exigée. On peut rester plusieurs années sans jamais travailler ni se former. Le système entretient l'inactivité et la dépendance.",
        "",
        "Après : Le RSA devient un tremplin vers l'emploi. La personne signe un Contrat d'Engagement Emploi : dès la 1ère semaine → activité encadrée, en 13 semaines → 35h hebdomadaires comme tout Français salarié. On récompense la continuité (prime de maintien), on sanctionne les refus injustifiés.",
        "",
        "➡️ Le RSA redevient ce qu'il aurait toujours dû être : une étape, pas une finalité.",
        "",
        "**2️⃣ Aide au logement (APL/ALF)**",
        "",
        "Avant : Aide versée même si la personne ne fait aucun effort pour trouver un emploi. Cela fige les gens dans leur situation. Les bailleurs doivent souvent gérer les retards de paiement.",
        "",
        "Après : L'aide au logement est maintenue tant que l'activité prévue dans le contrat est réellement suivie. Pas d'engagement → aide réduite progressivement. La société aide ceux qui avancent.",
        "",
        "➡️ Le logement devient le socle du retour à l'emploi, pas un coussin pour l'immobilisme.",
        "",
        "**3️⃣ Allocations familiales**",
        "",
        "Avant : Versées automatiquement pour chaque enfant, sans condition sur l'école ou la santé. Parfois utilisées pour tout sauf l'enfant.",
        "",
        "Après : La base reste garantie. Mais un bonus s'ajoute quand l'enfant va en cours régulièrement, fait ses bilans de santé, participe à des activités sportives ou culturelles.",
        "",
        "➡️ L'argent accompagne les efforts éducatifs et la santé.",
        "",
        "**4️⃣ Allocation de soutien familial (ASF)**",
        "",
        "Avant : Somme versée parce que l'autre parent n'assume pas son rôle. Mais aucune action n'est menée pour récupérer la pension due par le parent défaillant.",
        "",
        "Après : L'État avance toujours la pension (pour ne pas punir l'enfant), et se charge lui-même de la récupérer auprès du parent manquant. De plus, une partie de l'aide est fléchée cantine / transport scolaire.",
        "",
        "➡️ On soutient le parent présent, on responsabilise l'autre.",
        "",
        "**5️⃣ PAJE (Jeune enfant)**",
        "",
        "Avant : De l'argent liquide pour un bébé. Mais rien ne garantit qu'il est utilisé pour lait, couches, vêtements, puériculture.",
        "",
        "Après : La PAJE devient un Pass Bébé : produits vraiment pour le bébé, aucune dépense détournée, soutien direct au bon endroit.",
        "",
        "➡️ L'enfant est au centre de l'aide.",
        "",
        "**6️⃣ Allocation de rentrée scolaire**",
        "",
        "Avant : Un versement souvent détourné : téléphones, cigarettes, jeux vidéos… Pendant que l'enfant arrive sans matériel à l'école.",
        "",
        "Après : L'aide prend la forme de coupons fléchés : papeterie, livres, vêtements scolaires, fournitures de sport. Utilisation contrôlée par un simple scan.",
        "",
        "➡️ La rentrée devient une vraie chance, pas un prétexte à consommations inutiles.",
        "",
        "**7️⃣ Prime de Noël**",
        "",
        "Avant : Argent distribué la veille des fêtes : alcool, fêtes improvisées, aucun bénéfice durable pour l'enfant.",
        "",
        "Après : La prime devient un Bon Noël Enfant : jouets éducatifs, livres, vêtements d'hiver, activités culturelles.",
        "",
        "➡️ On remet du sens à la solidarité de fin d'année.",
        "",
        "**8️⃣ Prime d'activité**",
        "",
        "Avant : Versée dès les premiers jours d'un travail… Puis diminuée ou supprimée trop vite → peur de perdre → retour à l'inactivité.",
        "",
        "Après : Elle devient une prime de maintien dans l'emploi : +300 € après 3 mois tenus, +600 € après 6 mois.",
        "",
        "➡️ La personne a intérêt à continuer.",
        "",
        "---",
        "",
        "**🎯 L'esprit général de la réforme**",
        "",
        "La solidarité continue d'exister, mais elle devient juste. Elle n'est plus une récompense pour l'inactivité, mais un accompagnement vers l'autonomie. Elle ne remplace plus le travail, elle construit l'accès au travail."
      ],
